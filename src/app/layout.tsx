...
export const metadata: Metadata = {
  title: "Chess Club - Master the Art of Strategic Play",
  description: "Join our passionate chess community. Expert coaching, tournaments, and strategic analysis for players of all skill levels. Elevate your chess game today.",
  keywords: "chess club, chess lessons, chess tournaments, chess coaching, chess strategy, chess training, chess community",
  metadataBase: new URL("https://chessclub.com"),
  alternates: {
    canonical: "https://chessclub.com"
  },
  openGraph: {
    title: "Chess Club - Master the Art of Strategic Play",
    description: "Join our passionate chess community with expert coaching and tournaments for all skill levels.",
    url: "https://chessclub.com",
    siteName: "Chess Club",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763394256319-vrvkzauo.jpg",
      alt: "Chess board with strategic pieces"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "Chess Club - Master the Art of Strategic Play",
    description: "Join our passionate chess community with expert coaching and tournaments for all skill levels.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763394256319-vrvkzauo.jpg"]
  },
  robots: {
    index: true,
    follow: true
